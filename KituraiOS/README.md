...
The app is unchanged by the addition of a database since it is the [server](https://github.com/Andrew-Lees11/PersistentiOSKituraKit/tree/master/ToDoServer) which handles all calls to the database.
